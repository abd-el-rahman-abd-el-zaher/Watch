        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeaserLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OutDay = table.Column<int>(type: "int", nullable: false),
                    MalPage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.UserId, x.AnimeId });
                    table.ForeignKey(
